...
try 
{
   ...
   String ins_sql = "UPDATE  ketangjiaoxue SET ketangmingcheng=?, shoukexingshi=?, kechengxingzhi=?, shifou=?, xuefen=?, xueshi=?, shoukebangeshu=?, pingxingbangeshu=?, zuoyecishu=?, pigaicishu=?, dayicishu=?, beizhu=?";
