     ...
     <div class="manage_right_c">
     	...
     	<div class="clears"></div>
                            ...
                            <tr>
                                ...
                                <th class="text-center">校教研活动</th>
                                <th class="text-center">院教研活动</th>
                                <th class="text-center">院外教研活动</th>
                 ...
                 try 
{
   ...
   String sea_sql = "SELECT *  FROM richangjiaoyanhuodong ";
  
   String xijiaoyanhuodong =null;//id
   String yuanjiaoyanhuodong =null;
   String yuanwaijiaoyanhuiyi=null;
...
while (rs.next()) 
  ...
  xijiaoyanhuodong=rs.getString("xijiaoyanhuodong");
 yuanjiaoyanhuodong=rs.getString("yuanjiaoyanhuodong");
  yuanwaijiaoyanhuiyi=rs.getString("yuanwaijiaoyanhuiyi");
     ...
     <tbody>
		...
		<tr>
		<td class="text-center"><%=xijiaoyanhuodong %></td>
		<td class="text-center"><%= yuanjiaoyanhuodong%></td>
		<td class="text-center"><%= yuanwaijiaoyanhuiyi%></td>
...
%>
     ...
     <tbody id="yingsheng" style="display:none">
		...
		<tr><td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3></td>
