								...
								<table
									...
									<thead>
										<tr>
											...
											<th class="text-center">实训指导-更新</th>
...
// 		String shixunxiangmumingcheng = rs.getString("shixunxiangmumingcheng");
		...
		String shixunleixing = rs.getString("shixunleixing");
		String chengguoxingshi = rs.getString("chengguoxingshi");
		String beizhu = rs.getString("beizhu");
              ...
              %>
									...
									<form name="jbqk" action="shixunzhidao_update_back.jsp"
										method="get">
										<tbody>
											...
											<tr>
												...
												<td>时长:<input
													style="border: 0; background-color: #F9F9F9" type="text"
													name="shichang" value="<%=shichang%>"></td>
											...
											<tr>
												...
												<td>循环次数:<input
													style="border: 0; background-color: #F9F9F9" type="text"
													name="xunhuancishu" value="<%=xunhuancishu%>"></td>
...
<!-- 												<td>实训类型:<input -->
<!-- 													style="border: 0; background-color: #F9F9F9" type="text" -->
<%-- 													name="shixunleixing" value="<%=shixunleixing%>"></td> --%>
												<td>实训类型: <select name="shixunleixing">
														<option value="<%=shixunleixing%>"><%=shixunleixing%></option>
...
<!-- 												<td>成果形式:<input -->
<!-- 													style="border: 0; background-color: #F9F9F9" type="text" -->
<%-- 													name="chengguoxingshi" value="<%=chengguoxingshi%>"></td> --%>

												<td>成果形式: <select name="chengguoxingshi">
														<option value="<%=chengguoxingshi%>"><%=chengguoxingshi%></option>
