...
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE jiaocaijianshe SET  shenheqingkuang='"+shenhe+"'  WHERE  jiaocaimingcheng='"+ketimingcheng+"'";
...
<meta http-equiv='refresh'  content='1;../../index/JSP2.0/教材建设审核.jsp'/>
