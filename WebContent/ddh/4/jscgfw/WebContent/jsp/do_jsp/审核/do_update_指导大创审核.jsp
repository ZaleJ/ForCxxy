...
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE zhidaodachuang SET  shenheqingkuang='"+shenhe+"'  WHERE  xiangmumingcheng='"+ketimingcheng+"'";
...
<meta http-equiv='refresh'  content='1;../../index/JSP2.0/指导大创审核.jsp'/>
