...
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE shixunzhidao SET  shenheqingkuang='"+shenhe+"'  WHERE  shixunxiangmumingcheng='"+ketimingcheng+"'";
...
<meta http-equiv='refresh'  content='1;../../index/JSP2.0/实训指导审核.jsp'/>
