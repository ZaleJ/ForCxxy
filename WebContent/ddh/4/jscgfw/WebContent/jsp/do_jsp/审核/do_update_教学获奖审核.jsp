...
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE jiaoxuehuojiang SET  shenheqingkuang='"+shenhe+"'  WHERE  huojiangmingcheng='"+ketimingcheng+"'";
...
<meta http-equiv='refresh'  content='1;../../index/JSP2.0/教学获奖审核.jsp'/>
