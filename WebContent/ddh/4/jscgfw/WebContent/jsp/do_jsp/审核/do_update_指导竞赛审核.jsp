...
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE zhidaojingsai SET  shenheqingkuang='"+shenhe+"'  WHERE  jingsaimingcheng='"+ketimingcheng+"'";
...
<meta http-equiv='refresh'  content='1;../../index/JSP2.0/指导竞赛审核.jsp'/>
