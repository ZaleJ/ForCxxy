										...
										<tbody>
											...
											<tr>
												...
												<td>实习名称：<input
													...
													name="shiximingcheng" value="<%=shiximingcheng%>"></td>
											...
											<tr>
												...
												<td>指导内容: <select name="zhidaoneirong">
														<option value="<%=zhidaoneirong%>"><%=zhidaoneirong%></option>
...
<!-- 												<td>实习报告:<input -->
<!-- 													style="border: 0; background-color: #F9F9F9" type="text" -->
<%-- 													name="shixibaogao" value="<%=shixibaogao%>"></td> --%>


												<td>实习报告: <select name="shixibaogao">
														<option value="<%=shixibaogao%>"><%=shixibaogao%></option>
...
<!-- 												<td>是否批改:<input -->
<!-- 													style="border: 0; background-color: #F9F9F9" type="text" -->
<%-- 													name="shifoupigai" value="<%=shifoupigai%>"></td> --%>
												<td>是否批改: <select name="shifoupigai">
														<option value="<%=shifoupigai%>"><%=shifoupigai%></option>
