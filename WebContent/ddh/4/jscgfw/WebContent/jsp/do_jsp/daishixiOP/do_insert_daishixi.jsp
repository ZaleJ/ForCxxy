...
// 		ps.executeUpdate();
		...
		String ins_sql2 = "INSERT INTO daishixi(shiximingcheng, xuefen, shichang, xueshengrenshu, xunhuancishu, zhidaoneirong, shixibaogao, shifoupigai, beizhu, xuenian, shenheqingkuang, gonghao) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
