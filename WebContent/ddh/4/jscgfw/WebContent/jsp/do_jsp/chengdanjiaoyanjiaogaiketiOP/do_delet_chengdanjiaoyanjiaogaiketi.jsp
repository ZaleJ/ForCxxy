...
try 
{
   ...
   String ins_sql2 = "DELETE FROM co_jbqk_chengdanjiaoyanjiaogaiketi WHERE ketimingcheng=? and gonghao=? ";
 ...
 %>
   ...
   <meta http-equiv='refresh'  content='1;../../index/jsp/承担教研教改课题.jsp'  class="del" />
