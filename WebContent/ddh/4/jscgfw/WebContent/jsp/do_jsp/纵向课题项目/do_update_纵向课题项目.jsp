										...
										<tbody>
											...
											<tr>
												...
												<td>课题名称：<input
													...
													onfocus="this.blur()" type="text" name="ketimingcheng"
													value="<%=ketimingcheng%>"></td>
...
<%-- 													name="ketilaiyuan" value="<%=ketilaiyuan%>"></td> --%>
												<td>课题来源: <select name="ketilaiyuan">
														<option value="<%=ketilaiyuan%>"><%=ketilaiyuan%></option>
														<option value="国家自然科学基金">国家自然科学基金</option>
														<option value="国家社科基金">国家社科基金</option>
														<option value="省自然科学基金">省自然科学基金</option>
														<option value="省社科基金">省社科基金</option>
														<option value="省软科学课题">省软科学课题</option>
														<option value="省厅级">省厅级</option>
											...
											<tr>
												...
												<td>人物角色:<input
													style="border: 0; background-color: #F9F9F9" type="text"
													name="renwujuese" value="<%=renwujuese%>"></td>
											...
											<tr>
												...
												<td>课题性质:<input
													style="border: 0; background-color: #F9F9F9" type="text"
													name="ketixingzhi" value="<%=ketixingzhi%>"></td>
											...
											<tr>
												...
												<td>经费额度:<input
													style="border: 0; background-color: #F9F9F9" type="text"
													name="jingfeiedu" value="<%=jingfeiedu%>"></td>
											...
											<tr>
												...
												<td>理想时间:<input
													style="border: 0; background-color: #F9F9F9" type="text"
													name="lixiangshijian" value="<%=lixiangshijian%>"></td>
											...
											<tr>
												...
												<td>预计时间:<input
													style="border: 0; background-color: #F9F9F9" type="text"
													name="yujijietushijian" value="<%=yujijietushijian%>"></td>
											...
											<tr>
												...
												<td>结题结论:<input
													style="border: 0; background-color: #F9F9F9" type="text"
													name="jietijielun" value="<%=jietijielun%>"></td>
											...
											<tr>
												...
												<td>审核情况:<input
													style="border: 0; background-color: #F9F9F9" type="text"></td>
