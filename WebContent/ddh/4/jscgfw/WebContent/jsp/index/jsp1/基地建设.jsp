JSP2.0<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
     ...
     <div class="manage_right_c">
     	...
     	<div class="clears"></div>
                            ...
                            <tr>
                                ...
                                <th class="text-center">基地名称</th>
                                <th class="text-center">可接纳人数</th>
                                <th class="text-center">有无协议</th>
                                 <th class="text-center">主要工作</th>
                 ...
                 try 
{
   ...
   String sea_sql = "SELECT *  FROM jidijianshe ";
  
  
  
   String jidimingcheng =null;//id
   String kejienarenshu =null;
   String shijijienarenshu=null;
 String youwuxieyi=null;
   String zhuyaogongzuo=null;
    String beizhu=null;
...
while (rs.next()) 
 ...
 jidimingcheng=rs.getString("jidimingcheng");
 kejienarenshu=rs.getString("kejienarenshu");
  shijijienarenshu=rs.getString("shijijienarenshu");
youwuxieyi=rs.getString("youwuxieyi");
zhuyaogongzuo=rs.getString("zhuyaogongzuo");
beizhu=rs.getString("beizhu");
     ...
     <tbody>
		...
		<tr>
		<td class="text-center"><%=jidimingcheng %></td>
		<td class="text-center"><%= kejienarenshu%></td>
		<td class="text-center"><%= shijijienarenshu%></td>
		<td class="text-center"><%= youwuxieyi%></td>
		<td class="text-center"><%= zhuyaogongzuo%></td>
