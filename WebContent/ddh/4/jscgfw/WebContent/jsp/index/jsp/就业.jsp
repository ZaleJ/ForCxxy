     ...
     <div class="manage_right_c">
     	...
     	<div class="clears"></div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">直接推荐就业人数</td>
                                <td class="text-center">帮助联系就业</td>
                                <td class="text-center">参与就业指导</td>
                                <td class="text-center">辅导考研课程</td>
                                <td class="text-center">帮助考研录取</td>
                                <td class="text-center">指导学生成功创业</td>
...
if(paa!=null){  pa=Integer.parseInt(request.getParameter("pa"));}
	...
	//int pagecount=(int)Math.ceil((float)totaluser/(float)pagesize);
				       ...
				       try {
				        	String $sql = "SELECT count(*)  FROM co_jbqk_jiuye WHERE gonghao=? ";  
				         int  $totalNumber=6;
               ...
               $totalNumber=co_rs2.getInt(1); //总记录数
		           ...
		           $page =Integer.parseInt(request.getParameter("p"));
					...
					String sel_co_sql = "SELECT top "+ $pagesize+" ID  FROM co_jbqk_jiuye WHERE gonghao=? and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_jiuye WHERE gonghao="+Gonghao+")  ";
					
					String sel_ketang_sql = "SELECT *  FROM jiuye WHERE ID=? ";    
				  ...
				  String sel_co_sql2 = "SELECT top "+ $pagesize+" ID  FROM co_jbqk_jiuye WHERE gonghao="+Gonghao+" and xuenian="+ss+" and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_jiuye WHERE gonghao="+Gonghao+")  ";
					 String sel_co_sql3 = "SELECT ID  FROM co_jbqk_jiuye WHERE gonghao='"+Gonghao+"' and   xuenian="+ss+"  ";
...
// 				    	 String jingsaijibie = ketang_rs.getString("jingsaijibie");
							String zhijietuijianjiuyerenshu = ketang_rs.getString("zhijietuijianjiuyerenshu");
							String bangzhulianxijiuye = ketang_rs.getString("bangzhulianxijiuye");
							String canyujiuyezhidao = ketang_rs.getString("canyujiuyezhidao");
							String fudaokaoyankecheng = ketang_rs.getString("fudaokaoyankecheng");
							
							String bangzhukaoyanluqu = ketang_rs.getString("bangzhukaoyanluqu");
							String zhidaoxueshengchenggongchuangye = ketang_rs.getString("zhidaoxueshengchenggongchuangye");
		...
		<td class="text-center"><%=zhijietuijianjiuyerenshu%></td>
		<td class="text-center"><%=bangzhulianxijiuye%></td>
		
		<td class="text-center"><%=canyujiuyezhidao%></td>
		<td class="text-center"><%=fudaokaoyankecheng%></td>
		
		
		
		<td class="text-center"><%=bangzhukaoyanluqu%></td>
		<td class="text-center"><%=zhidaoxueshengchenggongchuangye%></td>

	
		<td class="text-center"><%=beizhu%></td>
		<td class="text-center"><%=xuenian%></td>
		<td class="text-center"><%=shenheqingkuang%></td>
		<td class="text-center"><nter"><a  href="../../do_jsp/jiuyeOP/jiuye_update_page.jsp?p=<%=ID%>">更新</a>||<a  class="del"  href="../../do_jsp/jiuyeOP/do_delet_jiuye.jsp?p=<%=ID%>">删除</a></td>
...
<!--翻页-->
 <form  action="../../do_jsp/jiuyeOP/do_insert_jiuye.jsp" method="get" >
  <tbody id="yingsheng" style="display:none">
		...
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="zhijietuijianjiuyerenshu"></td>
		
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="bangzhulianxijiuye"></td>
		
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="canyujiuyezhidao"></td>
		
		
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="fudaokaoyankecheng"></td>
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="bangzhukaoyanluqu"></td>
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="zhidaoxueshengchenggongchuangye"></td>
     ...
     <div class="row" style="padding:0px; margin:0px;">
             		<div class="pull-left">
                    	<div class="pagination">
							...
							<%  } else {%>
							<li ><a href="就业.jsp?p=<%=$page-1%>">«</a></li>
							<%  }%>
                           <!-- <li class="active"><a href="javascript:;">1 <span class="sr-only">(current)</span></a></li>-->
							...
							for(i = $page; i<=$page+2;i++){
								if(i<=$totalPage){ %>
                            <li <% if(i == $page) { %>class="active"<%  }%> ><a href="就业.jsp?p=<%=i %>"><%=i %></a></li>
                            <%
									}
								}%>
							<% if($page < $totalPage){%>
