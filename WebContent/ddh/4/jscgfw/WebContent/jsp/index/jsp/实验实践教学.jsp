														...
														<td>
															...
															<div class="table-responsive mt15">
																<table
																	...
																	<!--翻页-->
																	<form
																		action="../../do_jsp/shiyankechengOP/do_insert_shiyankecheng.jsp"
																		method="get">
																		<tbody id="yingsheng" style="display: none">
																			...
																			<tr>
																				...
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="zongshishu"></td>

																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="zhouxueshi"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="xueshengrenshu"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="pingxingbangeshu"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="meibanfenzucishu"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
...
<td class="text-center"><select name='shiyanleixing'>
		<option value="演示性">演示性</option>
		  ...
		  <option value="创新性">创新性</option>
																				...
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="shiyanbaogaocishu"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="pigaicishu"></td>
