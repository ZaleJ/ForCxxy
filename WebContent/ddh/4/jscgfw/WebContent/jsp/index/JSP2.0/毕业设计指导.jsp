                                  ...
                                  <th class="text-center">审核情况</th>
                                   <th class="text-center">操作</th>
									...
									<%
										...
										try {
											String $sql = "SELECT count(*)  FROM biyeshejizhidao WHERE gonghao=? ";
											int $totalNumber = 6;
											...
											if (request.getParameter("p") != null) {
												$page = Integer.parseInt(request.getParameter("p"));
																...
																String sel_co_sql = "SELECT top "+ $pagesize+" *  FROM biyeshejizhidao WHERE gonghao=?";
...
// 											String sel_ketang_sql = "SELECT top " + $pagesize + " *  FROM biyeshejizhidao WHERE kechengmingcheng=? ";
											...
											if (time2 == null) {
												...
												String sel_co_sql3 = "SELECT *  FROM biyeshejizhidao WHERE gonghao='" + Gonghao
														+ "' and   xuenian=" + ss + "  ";
		...
		<td class="text-center"><%=shenheqingkuang%></td>
									...
									<!--翻页-->
									<form action="../../do_jsp/biyeshejizhidaoOP/do_insert_biyeshejizhidao.jsp"
										method="get">
		...
		<td class="text-center"> <input type="submit" value="确认添加" class="btn btn-primary login__input pass" ></td>
									...
									<tbody>
										<td colspan='20' class="text-center"><input
