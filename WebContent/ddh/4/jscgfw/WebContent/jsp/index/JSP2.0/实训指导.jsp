														...
														<td>
															...
															<div class="table-responsive mt15">
																<table
																	...
																	<%
																		...
																		try {
																			...
																			String sel_co_sql = "SELECT top " + $pagesize
																					+ " shixunxiangmumingcheng  FROM co_jbqk_shixunzhidao WHERE gonghao=? and ID NOT IN(select top "
																					+ $jump + " ID FROM co_jbqk_shixunzhidao WHERE gonghao=" + Gonghao + ")  ";
																			...
																			if (time2 == null) {
																				...
																				String sel_co_sql2 = "SELECT top " + $pagesize
																						+ " shixunxiangmumingcheng  FROM co_jbqk_shixunzhidao WHERE gonghao=" + Gonghao
																						+ " and xuenian=" + ss + " and ID NOT IN(select top " + $jump
																						+ " ID FROM co_jbqk_shixunzhidao WHERE gonghao=" + Gonghao + ")  ";
																				String sel_co_sql3 = "SELECT shixunxiangmumingcheng  FROM co_jbqk_shixunzhidao WHERE gonghao='"
																		...
																		<tbody>
																			<tr>
																				...
																				<td class="text-center"><nter">
																					<a
																						href="../../do_jsp/shixunzhidaoOP/shixunzhidao_update_page.jsp?p=<%=shixunxiangmumingcheng%>">更新</a>||<a
																						class="del"
																						href="../../do_jsp/shixunzhidaoOP/do_delet_shixunzhidao.jsp?p=<%=shixunxiangmumingcheng%>">删除</a></td>
																	...
																	<!--翻页-->
																	<form
																		action="../../do_jsp/shixunzhidaoOP/do_insert_shixunzhidao.jsp"
																		method="get">
																		<tbody id="yingsheng" style="display: none">
																			...
																			<tr>
																				...
																				<td class="text-center"><input
																					...
																					type="text" size=3 name="shixunxiangmumingcheng"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
...
<!-- 																				<td class="text-center"><input -->
<!-- 																					style="border: 0; background-color: #F9F9F9" -->
<!-- 																					type="text" size=3 name="shixunleixing"></td> -->
																				<td class="text-center"><select
																					name='shixunleixing'>
																						<option value="实操类">实操类</option>
																						<option value="设计类">设计类</option>
																						<option value="实战类">实战类</option>
																				</select></td>
<!-- 																				<td class="text-center"><input -->
<!-- 																					style="border: 0; background-color: #F9F9F9" -->
<!-- 																					type="text" size=3 name="chengguoxingshi"></td> -->
																				<td class="text-center"><select
