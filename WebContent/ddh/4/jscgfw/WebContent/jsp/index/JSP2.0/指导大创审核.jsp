...
// 			}
			...
			// 根据选择的行创建一个表单，然后将这个表单提交给后台
			 ...
			 turnForm.action = '../../do_jsp/zhidaodachuangOP/zhidaodachuang_shenhe_back.jsp';
							...
							<div class="table-responsive mt15">
								<table
									...
									<div>
										...
										<form method='post' action="../../do_jsp/zhidaodachuangOP/zhidaodachuangshenheSearchPage.jsp">
									...
									String searchStr = request.getParameter("searchAll");
										...
										try {
											String $sql = "SELECT count(*)  FROM zhidaodachuang ";
											co_ps2 = con.prepareStatement($sql);
											if(searchStr!=null && !"".equals(searchStr)){
												$sql = "SELECT count(*)  FROM zhidaodachuang   where gonghao in (select gonghao from jbqk where xingming=? or xingbie=? or xueli=? or xuewei=? or zhicheng=? or zhiwu=? or zhengzhimianmao=? or qiandinghetongqingkuang=? or gonghao=? or suozaixibu=? or gaoxiaogongling=? or benkebiyexuexiao=? or huodezuigaoxuelideyuanxiaohuojigou=? or huodezuigaoxueweideyuanxiaohuojigou=? or gongchengshijianjingli=? or beizhu=?);";
												co_ps2 = con.prepareStatement($sql);
...
// 											co_ps2.setString(1, Gonghao);
											...
											if (request.getParameter("p") != null) {
												$page = Integer.parseInt(request.getParameter("p"));
																...
																String sel_co_sql = "SELECT top "+ $pagesize+" *  FROM zhidaodachuang";
									...
									<form id='ketang_ID' method='post'>
										<tbody>
											...
											<td class="text-center"><%=xiangmumingcheng%></td>
												...
												<td class="text-center"><a href="../../do_jsp/zhidaodachuangOP/zhidaodachuang_shenhe_back.jsp?id=<%=ID%>&shenheqingkuang=<%=shenheqingkuang%>"><%=shenheqingkuang%></a></td>
			...
			<div class="row" style="padding: 0px; margin: 0px;">
				<div class="pull-left">
					<div class="pagination">
						...
						%>
						<li><a href="zhidaodachuang.jsp?p=<%=$page - 1%>">«</a></li>
						<%
							}
						%>
						...
						<li <%if (i == $page) {%> class="active" <%}%>><a
							href="zhidaodachuang.jsp?p=<%=i%>"><%=i%></a></li>
						<%
							}
								}
						%>
