...
<script type="text/javascript">
	...
	function addForm(){
		...
		var canguanyindao = document.getElementById("canguanyindao");
		var chuanchajiangjie = document.getElementById("chuanchajiangjie");
		var xianchangdayi = document.getElementById("xianchangdayi");
		
		var zhidaoneirong = "";
		
		if(canguanyindao.checked){
			zhidaoneirong+=canguanyindao.value;
		}
		if(chuanchajiangjie.checked){
			zhidaoneirong+="  "+chuanchajiangjie.value;
		}
		if(xianchangdayi.checked){
			zhidaoneirong+="  "+xianchangdayi.value;
		}
		
		document.getElementById("zhidaoneirong").value = zhidaoneirong;
		addForm.submit();
	}
</script>
</head>
							...
							<div class="table-responsive mt15">
								<table
									...
									<%
										...
										try {
											String $sql = "SELECT count(*)  FROM daishixi WHERE gonghao=? ";
											int $totalNumber = 6;
											...
											if (request.getParameter("p") != null) {
												$page = Integer.parseInt(request.getParameter("p"));
																...
																String sel_co_sql = "SELECT top "+ $pagesize+" *  FROM daishixi WHERE gonghao=?";

// 											String sel_ketang_sql = "SELECT top " + $pagesize + " *  FROM daishixi WHERE kechengmingcheng=? ";
											...
											if (time2 == null) {
												...
												// 				  String sel_co_sql2 = "SELECT top "+ $pagesize+" kechengmingcheng  FROM co_jbqk_daishixi WHERE gonghao="+Gonghao+" and xuenian="+ss+" and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_daishixi WHERE gonghao="+Gonghao+")  ";
												String sel_co_sql3 = "SELECT *  FROM daishixi WHERE gonghao='" + Gonghao
														+ "' and   xuenian=" + ss + "  ";
...
// 												while (ketang_rs.next()) {
													...
													String zhidaoneirong = co_rs.getString("zhidaoneirong");
													String shixibaogao = co_rs.getString("shixibaogao");
													String shifoupigai = co_rs.getString("shifoupigai");
										...
										<tbody>
											...
											<td class="text-center"><%=ID%></td>
												...
												<td class="text-center"><a
													href="../../do_jsp/daishixiOP/daishixi_update_page.jsp?p=<%=ID%>">更新</a>||<a
													class="del"
													href="../../do_jsp/daishixiOP/do_delet_daishixi.jsp?p=<%=ID%>">删除</a></td>
									...
									<!--翻页-->
									<form action="../../do_jsp/daishixiOP/do_insert_daishixi.jsp"
										...
										<tbody id="yingsheng" style="display: none">
											...
											<tr>
												...
												<td class="text-center"><input
													...
													size=13 name="shiximingcheng"></td>
												<td class="text-center"><input
													style="border: 0; background-color: #F9F9F9" type="text"
												...
												<td class="text-center"><input
													style="border: 0; background-color: #F9F9F9" type="text"
													size=3 name="shichang"></td>

												<td class="text-center"><input
													style="border: 0; background-color: #F9F9F9" type="text"
													size=3 name="xueshengrenshu"></td>
												<td class="text-center"><input
													style="border: 0; background-color: #F9F9F9" type="text"
													size=3 name="xunhuancishu"></td>
												<td class="text-center"><input
													style="border: 0; background-color: #F9F9F9" type="hidden"
													size=3 name="zhidaoneirong" id="zhidaoneirong">
													<input type="checkbox" id="canguanyindao" value="参观引导" />参观引导
													<br/>
													<input type="checkbox" id="chuanchajiangjie" value="穿插讲解" />穿插讲解
													<br/>
													<input type="checkbox" id="xianchangdayi" value="现场答疑" />现场答疑
													</td>
												<td class="text-center">
													<select name="shixibaogao">
			...
			<div class="row" style="padding: 0px; margin: 0px;">
				<div class="pull-left">
					<div class="pagination">
						...
						%>
						<li><a href="daishixi.jsp?p=<%=$page - 1%>">«</a></li>
						<%
							}
						%>
