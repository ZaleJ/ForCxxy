														...
														<td>
															...
															<div class="table-responsive mt15">
																<table
																	...
																	<%
																		...
																		try {
																			...
																			String sel_co_sql = "SELECT top " + $pagesize
																					+ " shiximingcheng  FROM co_jbqk_daishixi WHERE gonghao=? and ID NOT IN(select top " + $jump
																					+ " ID FROM co_jbqk_daishixi WHERE gonghao=" + Gonghao + ")  ";
																			...
																			if (time2 == null) {
																				...
																				String sel_co_sql2 = "SELECT top " + $pagesize
																						+ " shiximingcheng  FROM co_jbqk_daishixi WHERE gonghao=" + Gonghao + " and xuenian=" + ss
																						+ " and ID NOT IN(select top " + $jump + " ID FROM co_jbqk_daishixi WHERE gonghao="
																						+ Gonghao + ")  ";
																				String sel_co_sql3 = "SELECT shiximingcheng  FROM co_jbqk_daishixi WHERE gonghao='" + Gonghao
																						+ "' and   xuenian=" + ss + "  ";
																		...
																		<tbody>
																			<tr>
																				...
																				<td class="text-center"><nter"> <a
																						href="../../do_jsp/daishixiOP/daishixi_update_page.jsp?p=<%=shiximingcheng%>">更新</a>||<a
																						class="del"
																						href="../../do_jsp/daishixiOP/do_delet_daishixi.jsp?p=<%=shiximingcheng%>">删除</a></td>
																	...
																	<!--翻页-->
																	<form
																		action="../../do_jsp/daishixiOP/do_insert_daishixi.jsp"
																		method="get">
																		<tbody id="yingsheng" style="display: none">
																			...
																			<tr>
																				...
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="shichang"></td>
																				...
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="xunhuancishu"></td>
																				<!-- 																				<td class="text-center"><input -->
																				<!-- 																					style="border: 0; background-color: #F9F9F9" -->
																				<!-- 																					type="text" size=3 name="zhidaoneirong"></td> -->
																				<td class="text-center"><select
																					name='zhidaoneirong'>
																						<option value="参观引导">参观引导</option>
																						<option value="穿插讲解">穿插讲解</option>
																						<option value="现场答疑">现场答疑</option>
																				</select></td>
																				<!-- 																				<td class="text-center"><input -->
																				<!-- 																					style="border: 0; background-color: #F9F9F9" -->
																				<!-- 																					type="text" size=3 name="shixibaogao"></td> -->
																				<td class="text-center"><select
																					name='shixibaogao'>
																				...
																				<!-- 																				<td class="text-center"><input -->
																				<!-- 																					style="border: 0; background-color: #F9F9F9" -->
																				<!-- 																					type="text" size=3 name="shifoupigai"></td> -->
																				<td class="text-center"><select
																					name='shixibaogao'>
