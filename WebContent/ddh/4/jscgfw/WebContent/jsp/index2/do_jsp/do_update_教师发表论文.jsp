...
a[i-1]=request.getParameter("a"+i);
 ...
 <%
   String s1="tecThesy_gernal";
               String s2="tecThesy_core";
                  String s3="tecThesy_EI";
                     String s4="tecThesy_AHCISSCI";
                      String s5="tecThesy_SCI";
 String ins_sql = "UPDATE Manager_Table SET";
 
 ins_sql=ins_sql+"  "+s1+"='"+a[0]+"',"+ s2+"='"+a[1]+"',"+s3+"='"+a[2]+"', "+s4+"='"+a[3]+"',"+s5+"='"+a[4]+"';";
...
<meta http-equiv='refresh'  content='1;../../index2/jsp/教师发表论文.jsp'/>
