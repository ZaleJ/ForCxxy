...
a[i-1]=request.getParameter("a"+i);
 ...
 <%
   String s1="inventPatent_invent";
               String s2="inventPatent_national";
                  String s3="inventPatent_practial";
                     String s4="inventPatent_design";
 String ins_sql = "UPDATE Manager_Table SET";
 
 ins_sql=ins_sql+"  "+s1+"='"+a[0]+"',"+ s2+"='"+a[1]+"',"+s3+"='"+a[2]+"', "+s4+"='"+a[3]+"';";
...
<meta http-equiv='refresh'  content='1;../../index2/jsp/专利和发明.jsp'/>
