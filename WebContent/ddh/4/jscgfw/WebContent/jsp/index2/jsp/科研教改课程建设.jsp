...
<div class="manage_right cl">
	 <h1 class="sub_title">科研教改课程建设</h1>
...
<%
 ...
 //String s=null;
 while(rs.next()){
            String a1="sciTecCusCost_National_";
               String a2="sciTecCusCost_Province_";
                  String a3="sciTecCusCost_College_";
                     String a4="sciTecCusCost_City_";
 ...
 <form name="jbqk"   action="../do_jsp/do_update_等项目.jsp" method="get"   >
