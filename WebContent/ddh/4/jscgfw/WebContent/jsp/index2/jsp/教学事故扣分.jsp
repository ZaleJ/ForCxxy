...
<th class="text-center">Ⅲ级事故(一般)</th>
<th class="text-center">Ⅱ级事故(重大)</th>
<th class="text-center">Ⅰ级事故(特大)</th>
...
<%
 ...
 //String s=null;
 while(rs.next()){
            String a1="TecDisaster_1";
               String a2="TecDisaster_2";
                  String a3="TecDisaster_3";
 ...
 <form name="jbqk"   action="../do_jsp/do_update_教学事故扣分.jsp" method="get"   >
