                 ...
                 try 
{
   ...
   String sea_sql = "select * from chengdanjiaoyanjiaogaiketi  where ketimingcheng=? ";
...
while (rs.next()) 
   {
		//String ketimingcheng = rs.getString("ketimingcheng");
		...
		String jietishijian = rs.getString("jietishijian");
		String xiangmuzhiliang = rs.getString("xiangmuzhiliang");
      ...
      <form name="jbqk"   action="chengdanjiaoyanjiaogaiketi_update_back.jsp" method="get"   >                                           
      <tbody> 
                                                 
		
		<tr>
		
		<td >实习名称：<input style="border:0; background-color:#F9F9F9" type="text"  name="ketimingcheng" value="<%=ketimingcheng%>"></td>
		...
		<td >结题时间:<input style="border:0; background-color:#F9F9F9" type="text"  name="jietishijian" value="<%=jietishijian%>"></td>
				
		</tr>
		<tr>
		
		<td >项目质量:<input style="border:0; background-color:#F9F9F9" type="text"  name="xiangmuzhiliang" value="<%=xiangmuzhiliang%>"></td>
