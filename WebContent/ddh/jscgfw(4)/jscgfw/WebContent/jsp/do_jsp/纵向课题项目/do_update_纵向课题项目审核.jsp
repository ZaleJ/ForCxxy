...
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE zongxiangketixiangmu SET  shenheqingkuang='"+shenhe+"'  WHERE  ketimingcheng='"+ketimingcheng+"'";
...
<meta http-equiv='refresh'  content='1;../../index/jsp/纵向课题项目审核.jsp'/>
