                 ...
                 try 
{
   ...
   String zhuanlimingcheng=request.getParameter("p");
   String sea_sql = "select * from shenqingzhuanli  where zhuanlimingcheng=? ";
...
while (rs.next()) 
 ...
 String    zhuanlimingcheng2=rs.getString("zhuanlimingcheng");
 String    zhuanlileixing=rs.getString("zhuanlileixing");  
  String    shenqingshijian=rs.getString("shenqingshijian");
  String    shifoushouli=rs.getString("shifoushouli");
 String    shifouhuoshouquan=rs.getString("shifouhuoshouquan");
 String    shifouhuozhuanhua=rs.getString("shifouhuozhuanhua");
 ...
 //String    beizhu=rs.getString("beizhu");
      ...
      <form name="jbqk"   action="申请专利_update_back.jsp" method="get"   >                                           
      <tbody> 
                                                 
		
		<tr>
		
		<td >专利名称：<input style="border:0; background-color:#F9F9F9"   onfocus="this.blur()"  type="text"  name="zhuanlimingcheng" value="<%=zhuanlimingcheng%>"></td>
				
		</tr>
		<tr>
		
		<td >专利类型:<input style="border:0; background-color:#F9F9F9" type="text"  name="zhuanlileixing" value="<%=zhuanlileixing%>"></td>
				
		</tr>
		<tr>
		
		<td >时期时间:<input style="border:0; background-color:#F9F9F9" type="text"  name="shenqingshijian" value="<%=shenqingshijian%>"></td>
				
		</tr>
		<tr>
		
		<td >是否受理:<input style="border:0; background-color:#F9F9F9" type="text"  name="shifoushouli"value="<%=shifoushouli%>"></td>
				
		</tr>
		
		<tr>
		
		<td >是否授权:<input style="border:0; background-color:#F9F9F9" type="text"  name="shifouhuoshouquan" value="<%=shifouhuoshouquan%>"></td>
				
		</tr>
		<tr>
		
		<td >是否获专利:<input style="border:0; background-color:#F9F9F9" type="text"  name="shifouhuozhuanhua" value="<%=shifouhuozhuanhua%>"></td>
