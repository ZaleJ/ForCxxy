...
String ketimingcheng="啊看见对方";
ketimingcheng=request.getParameter("ketimingcheng");
 String shenhe=request.getParameter("op");
 
 %>
 
<%=ketimingcheng+shenhe %>>
 
 <%
  
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE shenqingzhuanli SET  shenheqingkuang='"+shenhe+"'  WHERE  zhuanlimingcheng='"+ketimingcheng+"'";
...
<meta http-equiv='refresh'  content='1;../../index/jsp/申请专利审核.jsp'/>
