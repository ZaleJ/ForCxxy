...
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE shiyankecheng SET  shenheqingkuang='"+shenhe+"'  WHERE  shiyankechengmingcheng='"+ketimingcheng+"'";
...
<meta http-equiv='refresh'  content='1;../../index/jsp/实验实践教学审核.jsp'/>
