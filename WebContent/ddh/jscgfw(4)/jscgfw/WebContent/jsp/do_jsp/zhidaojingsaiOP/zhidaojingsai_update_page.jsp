...
// 		String jingsaimingcheng = rs.getString("jingsaimingcheng");
      ...
      <form name="jbqk"   action="zhidaojingsai_update_back.jsp" method="get"   >                                           
      <tbody> 
                                                 
		
		<tr>
		
		<td >项目名称：<input style="border:0; background-color:#F9F9F9" type="text"  name="jingsaimingcheng" value="<%=jingsaimingcheng%>"></td>
				
		</tr>
		<tr>
		
		<td >竞赛级别:<input style="border:0; background-color:#F9F9F9" type="text"  name="jingsaijibie" value="<%=jingsaijibie%>"></td>
				
		</tr>
		<tr>
		
		<td >获奖情况:<input style="border:0; background-color:#F9F9F9" type="text"  name="huojiangqingkuang" value="<%=huojiangqingkuang%>"></td>
