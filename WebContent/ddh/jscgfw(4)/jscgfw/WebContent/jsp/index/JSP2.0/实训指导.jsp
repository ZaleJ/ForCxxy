...
if(paa!=null){  pa=Integer.parseInt(request.getParameter("pa"));}
	...
	//int pagecount=(int)Math.ceil((float)totaluser/(float)pagesize);
				       ...
				       try {
				        	String $sql = "SELECT count(*)  FROM co_jbqk_shixunzhidao WHERE gonghao=? ";  
				         int  $totalNumber=6;
               ...
               $totalNumber=co_rs2.getInt(1); //总记录数
		           ...
		           $page =Integer.parseInt(request.getParameter("p"));
					...
					String sel_co_sql = "SELECT top "+ $pagesize+" shixunxiangmumingcheng  FROM co_jbqk_shixunzhidao WHERE gonghao=? and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_shixunzhidao WHERE gonghao="+Gonghao+")  ";
				  ...
				  String sel_co_sql2 = "SELECT top "+ $pagesize+" shixunxiangmumingcheng  FROM co_jbqk_shixunzhidao WHERE gonghao="+Gonghao+" and xuenian="+ss+" and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_shixunzhidao WHERE gonghao="+Gonghao+")  ";
					 String sel_co_sql3 = "SELECT shixunxiangmumingcheng  FROM co_jbqk_shixunzhidao WHERE gonghao='"+Gonghao+"' and   xuenian="+ss+"  ";
		...
		<td class="text-center"><nter"><a  href="../../do_jsp/shixunzhidaoOP/shixunzhidao_update_page.jsp?p=<%=shixunxiangmumingcheng%>">更新</a>||<a  class="del"  href="../../do_jsp/shixunzhidaoOP/do_delet_shixunzhidao.jsp?p=<%=shixunxiangmumingcheng%>">删除</a></td>
