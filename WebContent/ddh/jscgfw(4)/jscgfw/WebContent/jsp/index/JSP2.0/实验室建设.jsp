                 ...
                 try 
{
   ...
   String sea_sql = "SELECT *  FROM shiyanshijianshe ";
  
  
  
   String jianshexiangmufuzeren =null;//id
...
while (rs.next()) 
 ...
 jianshexiangmufuzeren=rs.getString("jianshexiangmufuzeren");
...
beizhu=rs.getString("beizhu");
     ...
     <tbody>
		...
		<tr>
		<td class="text-center"><%=jianshexiangmufuzeren %></td>
