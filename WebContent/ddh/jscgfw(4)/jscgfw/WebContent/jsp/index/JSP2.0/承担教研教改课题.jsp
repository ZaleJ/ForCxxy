...
if(paa!=null){  pa=Integer.parseInt(request.getParameter("pa"));}
	...
	//int pagecount=(int)Math.ceil((float)totaluser/(float)pagesize);
				       ...
				       try {
				        	String $sql = "SELECT count(*)  FROM co_jbqk_chengdanjiaoyanjiaogaiketi WHERE gonghao=? ";  
				         int  $totalNumber=6;
               ...
               $totalNumber=co_rs2.getInt(1); //总记录数
		           ...
		           $page =Integer.parseInt(request.getParameter("p"));
					...
					String sel_co_sql = "SELECT top "+ $pagesize+" ketimingcheng  FROM co_jbqk_chengdanjiaoyanjiaogaiketi WHERE gonghao=? and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_chengdanjiaoyanjiaogaiketi WHERE gonghao="+Gonghao+")  ";
				  ...
				  String sel_co_sql2 = "SELECT top "+ $pagesize+" ketimingcheng  FROM co_jbqk_chengdanjiaoyanjiaogaiketi WHERE gonghao="+Gonghao+" and xuenian="+ss+" and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_chengdanjiaoyanjiaogaiketi WHERE gonghao="+Gonghao+")  ";
					 String sel_co_sql3 = "SELECT ketimingcheng  FROM co_jbqk_chengdanjiaoyanjiaogaiketi WHERE gonghao='"+Gonghao+"' and   xuenian="+ss+"  ";
		...
		<td class="text-center"><nter"><a  href="../../do_jsp/chengdanjiaoyanjiaogaiketiOP/chengdanjiaoyanjiaogaiketi_update_page.jsp?p=<%=ketimingcheng%>">更新</a>||<a  class="del"  href="../../do_jsp/chengdanjiaoyanjiaogaiketiOP/do_delet_chengdanjiaoyanjiaogaiketi.jsp?p=<%=ketimingcheng%>">删除</a></td>
     ...
     <div class="row" style="padding:0px; margin:0px;">
             		<div class="pull-left">
                    	<div class="pagination">
							...
							<%  } else {%>
							<li ><a href="承担教研教改课题.jsp?p=<%=$page-1%>">«</a></li>
							<%  }%>
                           <!-- <li class="active"><a href="javascript:;">1 <span class="sr-only">(current)</span></a></li>-->
							...
							for(i = $page; i<=$page+2;i++){
								if(i<=$totalPage){ %>
                            <li <% if(i == $page) { %>class="active"<%  }%> ><a href="承担教研教改课题.jsp?p=<%=i %>"><%=i %></a></li>
                            <%
									}
								}%>
							<% if($page < $totalPage){%>
