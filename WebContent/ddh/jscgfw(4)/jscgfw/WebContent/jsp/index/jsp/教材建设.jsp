...
<div class="manage_right cl">
	 <h1 class="sub_title">专业建设~专业综合改革</h1>
                 ...
                 try 
{
   ...
   String sea_sql = "SELECT *  FROM jiaocaijianshe ";
  
  
  
   String jiaocaimingcheng =null;//id
   String chubanshe =null;
   String chubanshijian=null;
 String jiaocaizishu=null;
   String benrengongxian=null;
    String shifou=null;
      String beizhu=null;
...
while (rs.next()) 
 ...
 jiaocaimingcheng=rs.getString("jiaocaimingcheng");
 chubanshe=rs.getString("chubanshe");
  chubanshijian=rs.getString("chubanshijian");
jiaocaizishu=rs.getString("jiaocaizishu");
benrengongxian=rs.getString("benrengongxian");
shifou=rs.getString("shifou");
