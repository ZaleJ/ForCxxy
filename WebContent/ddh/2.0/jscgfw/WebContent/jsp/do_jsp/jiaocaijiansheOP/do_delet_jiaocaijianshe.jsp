...
try 
{
   ...
   String ins_sql = "DELETE FROM jiaocaijianshe WHERE jiaocaimingcheng=?";
   String ins_sql2 = "DELETE FROM co_jbqk_jiaocaijianshe WHERE jiaocaimingcheng=? and gonghao=? ";
 ...
 %>
   ...
   <meta http-equiv='refresh'  content='1;../../index/jsp/jiaocaimingcheng.jsp'  class="del" />
