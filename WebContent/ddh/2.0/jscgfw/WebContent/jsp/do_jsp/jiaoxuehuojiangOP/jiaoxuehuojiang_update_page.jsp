                 ...
                 try 
{
   ...
   String sea_sql = "select * from jiaoxuehuojiang  where huojiangmingcheng=? ";
...
while (rs.next()) 
   {
// 		String huojiangmingcheng = rs.getString("huojiangmingcheng");
		String huojiangmingcheng = rs.getString("huojiangmingcheng");
		String huojiangjibie = rs.getString("huojiangjibie");
		String huojiangdengji = rs.getString("huojiangdengji");
      ...
      <form name="jbqk"   action="jiaoxuehuojiang_update_back.jsp" method="get"   >                                           
      <tbody> 
                                                 
		
		<tr>
		
		<td >项目名称：<input style="border:0; background-color:#F9F9F9" type="text"  name="huojiangmingcheng" value="<%=huojiangmingcheng%>"></td>
				
		</tr>
		<tr>
		
		<td >获奖级别:<input style="border:0; background-color:#F9F9F9" type="text"  name="huojiangjibie" value="<%=huojiangjibie%>"></td>
				
		</tr>
		<tr>
		
		<td >获奖等级:<input style="border:0; background-color:#F9F9F9" type="text"  name="huojiangdengji" value="<%=huojiangdengji%>"></td>
				
		</tr>
		<tr>
		<td >指导形式:<input style="border:0; background-color:#F9F9F9" type="text"  name="zhidaoxingshi" value="<%=zhidaoxingshi%>"></td>
