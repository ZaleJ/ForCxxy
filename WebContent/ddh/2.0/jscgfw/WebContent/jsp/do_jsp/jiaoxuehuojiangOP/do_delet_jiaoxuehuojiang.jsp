...
try 
{
   ...
   String ins_sql = "DELETE FROM jiaoxuehuojiang WHERE huojiangmingcheng=?";
   String ins_sql2 = "DELETE FROM co_jbqk_jiaoxuehuojiang WHERE huojiangmingcheng=? and gonghao=? ";
 ...
 %>
   ...
   <meta http-equiv='refresh'  content='1;../../index/jsp/教学获奖.jsp'  class="del" />
