...
//Integer.parseInt(zuoyecishu)
   String ins_sql = "UPDATE  jiaoxuehuojiang SET huojiangjibie=?, huojiangdengji=?, zhidaoxingshi=?, "+
   "beizhu=? "+
   "WHERE huojiangmingcheng=? ";
  
  

   ps=con.prepareStatement(ins_sql);

 ps.setString(1,huojiangjibie);
 ps.setString(2,huojiangdengji);
 ps.setString(3,zhidaoxingshi);
 
ps.setString(4,beizhu );
 
ps.setString(5,huojiangmingcheng);
