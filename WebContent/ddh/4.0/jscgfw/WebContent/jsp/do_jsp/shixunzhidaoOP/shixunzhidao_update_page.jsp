...
// 		String shixunxiangmumingcheng = rs.getString("shixunxiangmumingcheng");
      ...
      <form name="jbqk"   action="shixunzhidao_update_back.jsp" method="get"   >                                           
      <tbody> 
                                                 
		
		<tr>
		
		<td >实习名称：<input style="border:0; background-color:#F9F9F9" type="text"  name="shixunxiangmumingcheng" value="<%=shixunxiangmumingcheng%>"></td>
		...
		<td >实训类型:<input style="border:0; background-color:#F9F9F9" type="text"  name="shixunleixing" value="<%=shixunleixing%>"></td>
				
		</tr>
		<tr>
		
		<td >成果形式:<input style="border:0; background-color:#F9F9F9" type="text"  name="chengguoxingshi" value="<%=chengguoxingshi%>"></td>
