	...
	//int pagecount=(int)Math.ceil((float)totaluser/(float)pagesize);
               ...
               $totalNumber=co_rs2.getInt(1); //总记录数
		           ...
		           $page =Integer.parseInt(request.getParameter("p"));
					...
					String sel_co_sql = "SELECT top "+ $pagesize+" shiyankechengmingcheng  FROM co_jbqk_shiyankecheng WHERE gonghao=? and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_shiyankecheng WHERE gonghao="+Gonghao+")  ";
				  ...
				  String sel_co_sql2 = "SELECT top "+ $pagesize+" shiyankechengmingcheng  FROM co_jbqk_shiyankecheng WHERE gonghao="+Gonghao+" and xuenian="+ss+" and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_shiyankecheng WHERE gonghao="+Gonghao+")  ";
					 String sel_co_sql3 = "SELECT shiyankechengmingcheng  FROM co_jbqk_shiyankecheng WHERE gonghao='"+Gonghao+"' and   xuenian="+ss+"  ";
					...
					co_rs = co_ps.executeQuery();  
				     ...
				     while (ketang_rs.next()) {
							...
							String zhoushishu = ketang_rs.getString("zhoushishu");
							String xueshengrenshu = ketang_rs.getString("xueshengrenshu");
							String pingxingbangeshu = ketang_rs.getString("pingxingbangeshu");
							String meibanfenzucishu = ketang_rs.getString("meibanfenzucishu");
							String zhidaojiaoshirenshu = ketang_rs.getString("zhidaojiaoshirenshu");
							String shiyanleixing = ketang_rs.getString("shiyanleixing");
							String shiyanbaogaocishu = ketang_rs.getString("shiyanbaogaocishu");
		...
		<td class="text-center"><nter"><a  href="../../do_jsp/shiyankechengOP/shiyankecheng_update_page.jsp?p=<%=shiyankechengmingcheng%>">更新</a>||<a  class="del"  href="../../do_jsp/shiyankechengOP/do_delet_shiyankecheng.jsp?p=<%=shiyankechengmingcheng%>">删除</a></td>
...
<!--翻页-->
 <form  action="../../do_jsp/shiyankechengOP/do_insert_shiyankecheng.jsp" method="get" >
  <tbody id="yingsheng" style="display:none">
                         
		<tr>
		
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="shiyankechengmingcheng"></td>
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="juese"></td>
		
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="zongshishu"></td>
		
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="zhouxueshi"></td>
		...
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="pingxingbangeshu"></td>
				<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="meibanfenzucishu" ></td>
				<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="zhidaojiaoshirenshu"></td>
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="shiyanleixing"></td>
		<td class="text-center"><input style="border:0; background-color:#F9F9F9" type="text" size=3 name="shiyanbaogaocishu"></td>
                    	...
                    	<div class="pagination">
                           ...
                           <!-- <li class="active"><a href="javascript:;">1 <span class="sr-only">(current)</span></a></li>-->
							...
							for(i = $page; i<=$page+2;i++){
								if(i<=$totalPage){ %>
                            <li <% if(i == $page) { %>class="active"<%  }%> ><a href="实验实践教学.jsp?p=<%=i %>"><%=i %></a></li>
                            <%
									}
								}%>
							<% if($page < $totalPage){%>
