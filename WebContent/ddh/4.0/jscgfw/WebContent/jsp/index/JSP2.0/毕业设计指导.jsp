																...
																<table
																	...
																	<thead>
																		<tr>
																			...
																			<th class="text-center">学生基础（好）</th>
																			<th class="text-center">学生基础（中）</th>
																			<th class="text-center">学生基础（差）</th>
																			<th class="text-center">毕业设计成绩（优）</th>
																			<th class="text-center">毕业设计成绩（良）</th>
																			<th class="text-center">毕业设计成绩（中）</th>
																			<th class="text-center">毕业设计成绩（及格）</th>
																			<th class="text-center">毕业设计成绩（不及格）</th>·
																			<th class="text-center">省优评选（一等）</th>·
																			<th class="text-center">省优评选（二等）</th>·
																			<th class="text-center">省优评选（三等）</th>·
																			<th class="text-center">省优评选（团队）</th>·
																	...
																	<%
																		...
																		try {
																			...
																			String sel_co_sql = "SELECT top " + $pagesize
																					+ " ID  FROM co_jbqk_biyeshejizhidao WHERE gonghao=? and ID NOT IN(select top " + $jump
																					+ " ID FROM co_jbqk_biyeshejizhidao WHERE gonghao=" + Gonghao + ")  ";
																			...
																			if (time2 == null) {
																				...
																				String sel_co_sql2 = "SELECT top " + $pagesize + " ID  FROM co_jbqk_biyeshejizhidao WHERE gonghao="
																						+ Gonghao + " and xuenian=" + ss + " and ID NOT IN(select top " + $jump
																						+ " ID FROM co_jbqk_biyeshejizhidao WHERE gonghao=" + Gonghao + ")  ";
																				String sel_co_sql3 = "SELECT ID  FROM co_jbqk_biyeshejizhidao WHERE gonghao='" + Gonghao
																						+ "' and   xuenian=" + ss + "  ";
...
<!-- 																				</td> -->
																	...
																	<!--翻页-->
																	<form
																		action="../../do_jsp/biyeshejizhidaoOP/do_insert_biyeshejizhidao.jsp"
																		method="get">
																		<tbody id="yingsheng" style="display: none">
																			...
																			<tr>
																				...
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="renshu"></td>
																				...
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="xueshengjichu_hao"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="xueshengjichu_zhong"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="xueshengjichu_cha"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="biyeshejichengji_hao"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="biyeshejichengji_liang"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="biyeshejichengji_zhong"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="biyeshejichengji_jige"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="biyeshejichengji_bujige"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="yideng"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="erdeng"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="sandeng"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="tuandui"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="beizhu"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="xuenian"></td>
																				<td class="text-center"><input
																					style="border: 0; background-color: #F9F9F9"
																					type="text" size=3 name="shenheqingkuang"></td>
