	...
	//int pagecount=(int)Math.ceil((float)totaluser/(float)pagesize);
               ...
               $totalNumber=co_rs2.getInt(1); //总记录数
		           ...
		           $page =Integer.parseInt(request.getParameter("p"));
					...
					String sel_co_sql = "SELECT top "+ $pagesize+" jingsaimingcheng  FROM co_jbqk_zhidaojingsai WHERE gonghao=? and ID NOT IN(select top "+$jump+" ID FROM co_jbqk_zhidaojingsai WHERE gonghao="+Gonghao+")  ";
		...
		<td class="text-center"><nter"><a  href="../../do_jsp/zhidaojingsaiOP/zhidaojingsai_update_page.jsp?p=<%=jingsaimingcheng%>">更新</a>||<a  class="del"  href="../../do_jsp/zhidaojingsaiOP/do_delet_zhidaojingsai.jsp?p=<%=jingsaimingcheng%>">删除</a></td>
                    	...
                    	<div class="pagination">
                           ...
                           <!-- <li class="active"><a href="javascript:;">1 <span class="sr-only">(current)</span></a></li>-->
							...
							for(i = $page; i<=$page+2;i++){
								if(i<=$totalPage){ %>
                            <li <% if(i == $page) { %>class="active"<%  }%> ><a href="指导竞赛.jsp?p=<%=i %>"><%=i %></a></li>
                            <%
									}
								}%>
							<% if($page < $totalPage){%>
