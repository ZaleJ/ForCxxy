                 ...
                 try 
{
   ...
   String sea_sql = "SELECT *  FROM kechengjianshe ";
  
   String kechengfuzeren =null;//id
...
while (rs.next()) 
 ...
 kechengfuzeren=rs.getString("kechengfuzeren");
...
chengdanrenwu=rs.getString("chengdanrenwu");
     ...
     <tbody>
		...
		<tr>
		<td class="text-center"><%=kechengfuzeren %></td>
