...
<div class="manage_right cl">
	 <h1 class="sub_title">教师参加各类竞赛</h1>
...
<%
 ...
 //String s=null;
 while(rs.next()){
            String a1="TecAcc_National_";
               String a2="TecAcc_Provence_";
                  String a3="TecAcc_City_";
                     String a4="TecAcc_College_";
 ...
 <form name="jbqk"   action="../do_jsp/do_update_教师参加各类竞赛.jsp" method="get"   >
