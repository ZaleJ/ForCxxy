...
<th class="text-center">发明专利授权</th>
<th class="text-center">国家已受理发明专利</th>
<th class="text-center">实用新型专利授权</th>
<th class="text-center">外观设计专利授权</th>
...
<%
 ...
 //String s=null;
 while(rs.next()){
            String a1="inventPatent_invent";
               String a2="inventPatent_national";
                  String a3="inventPatent_practial";
                     String a4="inventPatent_design";
 ...
 <form name="jbqk"   action="../do_jsp/do_update_专利和发明.jsp" method="get"   >
